    ...
    <div className="bg-[#F7F8FA]">
      ...
      <div className="px-[6.25rem] bg-[#FFFFFF] pt-[6.25rem] py-[7.188rem]">
        ...
        <div className="grid grid-cols-4">
          ...
          <div className="col-span-2 row-span-2 flex flex-col items-center mb-[2.938rem]">
            <div className="w-full h-[621px] relative mb-[0.7rem]">
              <Image
                src="/assets/images/blog-big.svg"
                alt="blog-picture"
                fill
              />
            </div>
